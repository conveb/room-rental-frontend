    ...
    <>
      ...
      <div className="min-h-screen md:px-8 py-3 md:py-6 text-xs md:text-sm bg-gray-50/50">
        ...
        <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
          {loading && (
            <div className="p-12 text-center text-gray-500 italic">Loading audit logs...</div>
          )}
          {error && (
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between px-6 py-4 border-t bg-gray-50/60">
                  ...
                  <div className="flex items-center gap-1">
                    {pageWindow[0] > 1 && (
                      <>
                        <button onClick={() => setCurrentPage(1)} className="w-8 h-8 rounded-lg text-xs font-medium hover:bg-white hover:shadow-sm transition-all border border-transparent hover:border-gray-200">
                          1
                        </button>
                    ...
                    {pageWindow[pageWindow.length - 1] < totalPages && (
                      <>
                        ...
                        <button onClick={() => setCurrentPage(totalPages)} className="w-8 h-8 rounded-lg text-xs font-medium hover:bg-white hover:shadow-sm transition-all border border-transparent hover:border-gray-200">
                          {totalPages}
                        </button>
                      </>
                    )}

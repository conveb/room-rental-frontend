    ...
    <section className="relative">
      ...
      <div className="relative w-full aspect-square rounded-[2rem] overflow-hidden bg-gray-200">
        ...
        <div className="absolute top-2 md:top-4 right-0 left-0 flex justify-between items-center px-2 md:px-4">
          <span className="flex items-center gap-2 text-[10px] md:text-xs text-white bg-black/60 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10 shadow-[0_0_10px_rgba(34,197,94,0.3)]">
            {/* The Glowing Circle */}
            ...
            <p className="font-medium">Available: {property.available_from}</p>
          </span>
          <div>
            <button
